<?php
    ...
    $sql = "SELECT * FROM employees WHERE fname LIKE '%$name%' ";
    ...
    <div class="container">
        ...
        <?php if ($count > 0) { ?>
            <form action="searchData.php" method="POST">
                ...
                <input class="form-control" type="text" placeholder="Enter Name Employee" name="empname">
        ...
        <button class="btn btn-info" onclick="checkAll()">Select All</button>
