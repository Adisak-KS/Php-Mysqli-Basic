    ...
    <div class="container my-3">
        ...
        <form action="insertData.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="radio" class="form-check-input" name="gender" id="" value="Male"> Male
                <input type="radio" class="form-check-input" name="gender" id="" value="Female"> Female
                <input type="radio" class="form-check-input" name="gender" id="" value="Other"> Other
            </div>
